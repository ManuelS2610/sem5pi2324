...
export default class ThumbRaiser {
    ...
    setMazeUrl(newUrl) {
        if (this.mazeParameters.url) {
            this.mazeParameters.url = newUrl;  
        } else {
            console.error("Maze data not found. Make sure it is properly initialized.");
        }
    }

    reloadScene(newMazeUrl) {
        this.gameRunning = false;
        this.scene.remove(this.maze);
        this.setMazeUrl(newMazeUrl);
